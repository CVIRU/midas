# |------------------------------------------------------------------------------|
# | Project: Big MIDAS dataset exploration                                       |
# | Script: Source code for MIDAS data export from CSV and conversion to R data  |     
# | Author: Davit Sargsyan                                                       | 
# | Created:  07/08/2017                                                         |
# | Modified: 02/05/2018                                                         |
# |           03/02/2018: read all columns as character to avoid issues in PROCs |
# |           03/16/2018: remove data prior to 1995                              |
# |           11/07/2018: received big MIDAS                                     |
# |------------------------------------------------------------------------------|
# Header----
# Save consol output to a log file
# sink(file = "tmp/log_export_big_midas_from_csv_to_rdata_v1.R.txt")
date()
...
# Read Big MIDAS 1995-2016 from CSV----
system.time(cf <- count.fields(file = "E:/MIDAS/big_midas/admissions_19862016.csv",
                               sep = ",",
                               skip = ))
# user  system elapsed 
# 146.25    5.92  156.67 
...
tmp <- fread("E:/MIDAS/big_midas/admissions_19862016.csv",
              colClasses = c("character"),
             nrows = 100)
tmp

bm16 <- fread("E:/MIDAS/big_midas/admissions_19862016.csv",
                 colClasses = c("character"))
summary(midas15)
